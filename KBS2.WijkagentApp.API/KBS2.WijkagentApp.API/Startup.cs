...
namespace KBS2.WijkagentApp.API
{
    public class Startup
    {
        ...
        {
            services.AddDbContext<WijkagentContext>(options => options.UseSqlServer(Configuration.GetConnectionString("DefaultConnection")));
