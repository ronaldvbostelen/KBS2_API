...
namespace KBS2.WijkagentApp.API.Controllers
{
    ...
    public class SocialMessagesController : ControllerBase
    {
        ...
        public SocialMessagesController(WijkagentContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> PostSocialMessage([FromBody] SocialMessage socialMessage)
        {
            ...
            {
                if (SocialMessageExists(socialMessage.socialsId))
                {
        ...
        {
            return _context.SocialMessage.Any(e => e.socialsId == id);
        }
    }
}